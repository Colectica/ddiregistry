    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    LastExport = table.Column<DateTimeOffset>(nullable: false),
                    LastModified = table.Column<DateTimeOffset>(nullable: false),
                    LastSoa = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExportActions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicalContactId = table.Column<string>(nullable: true),
                    AdminContactId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Agencies", x => x.AgencyId);
                    table.ForeignKey(
                        name: "FK_Agencies_AspNetUsers_AdminContactId",
                        column: x => x.AdminContactId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Agencies_AspNetUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Agencies_AspNetUsers_TechnicalContactId",
                        column: x => x.TechnicalContactId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameServer = table.Column<string>(maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Delegations_Assignments_AssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_Assignments_AssignmentId",
                        column: x => x.AssignmentId,
                        principalTable: "Assignments",
                        principalColumn: "AssignmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Agencies_AdminContactId",
                table: "Agencies",
                column: "AdminContactId");

            migrationBuilder.CreateIndex(
                name: "IX_Agencies_CreatorId",
                table: "Agencies",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Agencies_TechnicalContactId",
                table: "Agencies",
                column: "TechnicalContactId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Delegations_AssignmentId",
                table: "Delegations",
                column: "AssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Services_AssignmentId",
                table: "Services",
                column: "AssignmentId");
        }
